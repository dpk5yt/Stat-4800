...
down_one <- function(D, YTG, FP) {
  ...
  if (is_touchdown) {
    return(list(D = D, YTG = YTG, FP = 105, exit_drive = 1))
  }
  ...
  if (new_YTG <= 0) {
    ...
    # go to 2nd down 
    return(list(D = 2, YTG = new_YTG, FP = new_FP, exit_drive = 0))
  }
}
...
down_two <- function(D, YTG, FP) {
  ...
  if (new_YTG <= 0) {
    ...
    # go to to 3rd 
    return(list(D = 3, YTG = new_YTG, FP = new_FP, exit_drive = 0))
  }
}
...
down_three <- function(D, YTG, FP) {
  ...
  if (new_YTG <= 0) {
    ...
    # go to 4th 
    return(list(D = 4, YTG = new_YTG, FP = new_FP, exit_drive = 0))
  }
}
